...
const StatCard = ({ title, value, subtext, icon: Icon, color }) => (
  ...
  >
    ...
    <h3 className="text-txt-secondary text-sm font-medium uppercase tracking-wider">
      {title}
    </h3>
...
const Dashboard = ({ token }) => {
  ...
  if (loading)
    return (
      <div className="p-10 text-txt-primary">Syncing Financial Data...</div>
    );
  if (!data || !data.debts)
    return <div className="p-10 text-txt-primary">No Data Found.</div>;
    ...
    <div className="animate-enter">
      <header className="mb-8">
        ...
        <p className="text-txt-secondary">
          Real-time analysis of your debt portfolio.
        </p>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <StatCard
          title="Debt Free By"
          value={debtFreeDate.toLocaleDateString("en-US", {
            month: "short",
            year: "numeric",
          })}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 card-base p-6 h-[400px]">
          <h3 className="text-lg font-bold text-txt-primary mb-6">
        ...
        <div className="card-base p-6">
          ...
          <div className="space-y-3 custom-scroll max-h-[300px] overflow-y-auto">
            {data.debts.map((d) => (
              <div
                key={d._id}
                className="p-4 rounded-xl bg-bg-secondary border border-border flex justify-between items-center"
              >
                <div>
            ...
            {data.debts.length === 0 && (
              <p className="text-txt-secondary text-sm">No debts added yet.</p>
            )}
          </div>
        </div>
      </div>
